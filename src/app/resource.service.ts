...
//Used in auth interceptor
  ...
  sendTitleForWebResource(goaltitle){
    ...
    this.http.post(`${this.uri}/mydb/resourceWebCall`, this.goaltitleObject)
              .subscribe(function(res){
                console.log(res);
  ...
  sendTitleForVidResource(goaltitle){
    console.log(typeof(goaltitle));
    this.goaltitleObject = { goaltitle: goaltitle};
    this.http.post(`${this.uri}/mydb/resourceVidCall`, this.goaltitleObject)
              .subscribe(function(res){
                console.log(res);
                console.log("Yay it worked");
              });
  ...
  sendTitleForRedResource(goaltitle){
    console.log(typeof(goaltitle));
    this.goaltitleObject = { goaltitle: goaltitle};
    this.http.post(`${this.uri}/mydb/resourceRedCall`, this.goaltitleObject)
              .subscribe(function(res){
                console.log(res);
                console.log("Yay it worked");
              });
...
////Deletion after goal creation
  deleteWebList(){
     return this.http.get(`${this.uri}/mydb/deleteWebAfterNewGoal`);
  }
  deleteVidList(){
     return this.http.get(`${this.uri}/mydb/deleteVideoAfterNewGoal`);
  }
  deleteRedList(){
     return this.http.get(`${this.uri}/mydb/deleteRedditAfterNewGoal`);
  }
  deleteVidResList(){
